...
constructor(
                ...
                ItemTouchHelper(
                    object: ItemTouchHelper.SimpleCallback(
                        ...
                        override fun clearView(
                            ...
                            if ((mPositionDraggedFrom != -1)
                                and (mPositionDraggedTo != -1)
                                and (mPositionDraggedFrom != mPositionDraggedTo)) {
    ...
    private fun alertDialogForDeleteList(position: Int, title: String) {
        ...
        builder.setMessage("Pakka daffa karna esnu ?? Paaki gall aa? $title")
        builder.setIcon(android.R.drawable.ic_dialog_alert)
        builder.setPositiveButton("Aaho") { dialogInterface, _ ->
        ...
        builder.setNegativeButton("Naahi ji") { dialogInterface, _ ->
            dialogInterface.dismiss()
        }
